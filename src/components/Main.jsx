...
const Main = () => {
  ...
  return (
    <main>
      <h2 className="font-semibold text-xl my-1">Menu</h2>
          ...
          {nav.map((item, key) => {
            return (
              <NavLink
                ...
                key={key}
                className={({ isActive }) =>
                  `flex items-center gap-2 text-xl  hover:w-full  hover:border border-gray-200 rounded-lg  p-1 
     ${isActive ? " w-full border-2 p-1" : ""}`
                }
              >
                <span>{item.icon}</span>
                <span>{item.text}</span>
        ...
        <h2 className="font-semibold text-xl my-2">Boshqalar</h2>
        <ul className="flex items-start flex-col gap-4">
          {others.map((i, key) => {
            return (
              <NavLink
